...
% The "plain" theorem style is used for fundamental mathematical results.
% It formats the title in bold and the theorem body in italics.
\theoremstyle{plain}
\newtheorem*{theorem}{Theorem}       % Theorem: A general mathematical statement with a proof.
\newtheorem*{lemma}{Lemma}           % Lemma: A supporting result used in proving theorems.
\newtheorem*{proposition}{Proposition} % Proposition: A less fundamental theorem, but still an important statement.
% The "definition" theorem style is used for explanatory content.
% It formats the title in bold and the body text in normal (Roman) font.
\theoremstyle{definition}
\newtheorem*{definition}{Definition} % Definition: A precise explanation of a mathematical concept.
\newtheorem*{example}{Example}       % Example: A specific instance illustrating a concept.
% The "remark" theorem style is used for informal observations or comments.
% It formats the title in italics and the body text in normal (Roman) font.
\theoremstyle{remark}
